        ...
        <div className="w-full h-fit flex flex-wrap justify-center mt-[-32px]">
          <div className="w-full max-w-[500px] md:max-w-[800px] h-fit text-justify text-sm/6 lg:text-lg/8">
            ...
            >
              ...
              see and interact with. Front-end developers aim to create a
              positive user experience and an attractive and functional
              interface. The existence of front-end developers provides many
              benefits, the main one being branding and professional image by
              reflecting a positive image of the company or brand.
            </ScrollReveal>
          </div>
          <div className="w-full max-w-[500px] md:max-w-[800px] h-fit text-justify text-sm/6 lg:text-lg/8 mt-[-16px]">
            ...
            >
              ...
              various fields that involve digital interaction with users, such
              as information technology and stratups, E-commerce, finance,
              education, health. tourism, graphic design, and game development.
              in this digital era I am ready to realize, design, and build these
